...
COPY media_plan_spots_geo FROM LOCAL '\\et\dfs\Grupitöö\koordinaadid_new.csv' DELIMITER ',' ENCLOSED BY '"' SKIP 1;
COPY media_plan_spots_geo FROM LOCAL '\\et\dfs\Grupitöö\koordinaadid_new_full.csv' DELIMITER ';' SKIP 1;
